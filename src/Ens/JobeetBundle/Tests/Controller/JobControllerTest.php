...
class JobControllerTest extends WebTestCase
{
    ...
    public function testIndex()
    {
        ...
        $this->assertEquals('Ens\JobeetBundle\Controller\JobController::showAction',
            $client->getRequest()->attributes->get('_controller'));
        ...
        $crawler = $client->request('GET', sprintf('/job/sensio-labs/paris-france/%d/web-developer-expired',
